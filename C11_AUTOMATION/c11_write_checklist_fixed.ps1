# c11_write_checklist.ps1 (fixed date format)
...
# Append a PREP log entry (fixed: use -Format)
$logEntry = "| $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') | c11_write_checklist | OK | [PREP] CHECKLIST_PREP.md created in C06_dev (no prod changes)"
